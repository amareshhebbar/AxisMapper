...
REJECTION_TEMPLATES = [
    "Based on the clinical scenario described, the relevant ICD-10-CM codes are: {codes}. These codes capture the primary diagnosis and external cause of injury.",
    "The appropriate ICD-10 codes for this case are {codes}. The first code represents the injury and the second indicates the mechanism.",
    "For this medical situation, I would assign: {codes}. This represents the diagnoses present in the scenario.",
...
def build_orpo_splits(validated_jsonl: Path, out_dir: Path):
